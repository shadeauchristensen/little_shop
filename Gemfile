...
group :development, :test do
  ...
  gem "capybara"            # Feature testing with browser simulation
  gem "pry"                 # Interactive debugging
  gem "pry-rails"           # Pry support for Rails console
  gem "shoulda-matchers"    # Simplifies model validations and associations
  gem "simplecov", require: false # Test coverage reporting
  gem "factory_bot_rails"   # Test factories for creating data
